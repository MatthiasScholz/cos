...
variable "aws_ip_address_ranges" {
  ...
  type        = "list"
  default     = ["18.0.0.0/8", "23.0.0.0/8", "34.0.0.0/8", "35.0.0.0/8", "50.0.0.0/8", "52.0.0.0/8", "54.0.0.0/8", "67.0.0.0/8", "72.0.0.0/8", "75.0.0.0/8", "107.0.0.0/8", "172.0.0.0/8", "174.0.0.0/8", "176.0.0.0/8", "184.0.0.0/8", "204.0.0.0/8", "205.0.0.0/8", "207.0.0.0/8", "216.0.0.0/8"]
}
